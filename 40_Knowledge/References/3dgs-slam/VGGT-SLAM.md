...
### Concepts
- [[Projective-Ambiguity-Awareness]] — foundation model error ≠ just Sim(3)
- [[Feed-Forward-Submap]] — multi-frame feedforward submap
...
### Project
- [[10_Projects/SkelGS-SLAM/decision-log|SkelGS-SLAM: VGGT-SLAM 分析]]
