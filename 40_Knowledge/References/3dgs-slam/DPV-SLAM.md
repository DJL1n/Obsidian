...
## 相关笔记
- [[slam-frontends/patch-based/DPVO]] → [[gs-slam/monocular/DPV-SLAM]] 是端到端 SLAM 的重要里程碑
- 与 [[gs-slam/monocular/GS-SLAM]] 系列的关键差异：没有用 GS 做建图，而是用传统 volumetric 方法

## 方法继承

- **前作**：[[slam-frontends/patch-based/DPVO]]（DPVO → SLAM）
- **后继**：无
