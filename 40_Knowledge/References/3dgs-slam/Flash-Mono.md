...
初始化自 [[geometry-model/CUT3R]]。三阶段 curriculum training。
...
### Tracking (ATE RMSE)
| Dataset | Flash-Mono | [[slam-frontend/MASt3R-SLAM]] | ORB-SLAM3 | DROID-SLAM |
|---|---|---|---|---|
...
### Concepts
- [[../Concepts/gs-primitive/Predict-and-Refine-Gaussian.md]] — feed-forward predict + light refine
- [[../Concepts/submap/Hidden-State-Submap-Descriptor.md]] — recurrent hidden state as submap evidence
...
- **前作**：[[3dgs-slam/MonoGS]], [[slam-frontend/DROID-SLAM]], [[geometry-model/MASt3R]], [[slam-frontend/DPVO]]（predict-and-refine monocular）
- **后继**：无
