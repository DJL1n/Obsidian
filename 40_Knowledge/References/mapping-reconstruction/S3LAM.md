...
- 不是 [[gs-slam/monocular/GS-SLAM]]
- 不是 DROID-style learned recurrent BA
- 不是 [[geometry-priors/feed-forward/MASt3R]]-style pointmap SLAM
...
结构先验是后加约束，不是像 DROID 或 [[geometry-priors/feed-forward/MASt3R]]-SLAM 那样全流程可微或 pointmap prior 放到底层。
...
## 15. 与 [[geometry-priors/feed-forward/MASt3R]]-SLAM 的区别

| | [[geometry-priors/feed-forward/MASt3R]]-SLAM | S3LAM |
|---|---|---|
...
## 16. 与 [[slam-frontends/neural-correspondence/DROID-SLAM]] 的区别

| | [[slam-frontends/neural-correspondence/DROID-SLAM]] | S3LAM |
|---|---|---|
...
## 17. 对 [[gs-slam/monocular/GS-SLAM]] / 3DGS 的启发
...
5. **补 [[slam-frontends/patch-based/DPVO]]/DROID 的短板** — DROID 给 temporal evidence，S3LAM 给 semantic/structural grouping
...
S3LAM 的价值不在于比 DROID/[[geometry-priors/feed-forward/MASt3R]] 更强，而在于提出清楚思路：SLAM map 不应只是几何点云；语义实例和结构 primitive 可以反过来约束几何优化。
...
**四篇论文的定位：**
- [[geometry-priors/feed-forward/MASt3R]]-SLAM: strong two-view dense geometry prior
- [[slam-frontends/neural-correspondence/DROID-SLAM]]: dense recurrent temporal optimization signal
- [[slam-frontends/patch-based/DPVO]]: lightweight sparse temporal optimization signal
