...
高频：DPVO/DROID window。低频：MASt3R/[[matching-representation/LightGlue]] retrieval → long-range correspondence evidence。Anchor admission：只有被高频 window + 低频 reobservation 同时支持的点才进入 mature。
