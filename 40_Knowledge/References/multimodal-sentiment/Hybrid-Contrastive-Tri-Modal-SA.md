...
## 主题标签
#contrastive-learning #multi-granularity #infonce

## 相关论文

- [[MOCOLNet-Modality-Contrastive-Learning.md]] — 同样是模态对比学习，但本文强调实例级+模态级双粒度
- [[Hierarchical-Mutual-Information-Multimodal-SA.md]] — 多粒度 vs 分层的互信息优化
- [[ConFEDE-Contrastive-Federated-Domain-Adaptation.md]] — 对比学习+跨域迁移的组合
