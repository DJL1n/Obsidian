...
|---|---|---|---|---|
| [[geometry-model/DUSt3R]] | 0.407 | 0.393 | 0.463 | 0.335 |
...
|---|---|---|---|
| [[geometry-model/DUSt3R]] | 1.474 | 0.914 | 2.995 |
...
### Concepts
- [[../Concepts/scale/SNR-Aware-Reliability-Gating.md]] — 区域自适应观测可靠性，决定 anchor admission
- [[../Concepts/tracking/Motion-Geometry-Coherence-Loss.md]] — 运动约束作为 pose-depth 一致性认证信号
