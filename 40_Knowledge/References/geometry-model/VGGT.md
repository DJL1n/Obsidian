...
### Concepts
- [[../Concepts/geometry/Multi-View-Geometry-Packet.md]] — VGGT 一次输出 camera+depth+pointmap+track
- [[../Concepts/geometry/Feed-Forward-vs-Optimization.md]] — neural prediction vs factor graph geometry
...
- **前作**：[[geometry-model/DUSt3R]], [[geometry-model/MASt3R]]（视觉几何通用模型，CVPR best paper）
- **后继**：[[geometry-model/VGGT-SLAM]]
