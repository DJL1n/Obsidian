...
SEGS-SLAM 是一个结构化 3DGS-SLAM 系统，支持 monocular/stereo/RGB-D。核心是把 [[matching-representation/Scaffold-GS]] 的 anchor-Gaussian 表示引入 SLAM，提出 Appearance-from-Motion Embedding (AfME) 和 frequency regularization pyramid 提升 photorealistic mapping quality。不是 [[slam-frontend/DPVO]]/DROID 前端 / pointmap prior / global correction system。
...
### Structured GS ([[matching-representation/Scaffold-GS]] style)
...
## 5. 与 [[matching-representation/Scaffold-GS]] 关系

[[matching-representation/Scaffold-GS]]: offline NVS, anchor scaffold, view-adaptive Gaussians
SEGS-SLAM (early name Scaffold-SLAM): SLAM setting, structured GS, AfME, frequency pyramid

SEGS-SLAM = [[matching-representation/Scaffold-GS]] ideas brought into SLAM + appearance embedding + frequency control
...
1. **不是几何认证框架** — 无 [[slam-frontend/DPVO]] residual / free-space gate / anchor maturity
...
### 合理系统位置
```
[[slam-frontend/DPVO]]/DROID → temporal
[[geometry-model/MASt3R]]/[[geometry-model/DUSt3R]]/[[geometry-model/SLAM3R]]/[[geometry-model/CUT3R]] → proposal
...
| [[matching-representation/Scaffold-GS]] | anchor-conditioned GS | representation source |
| VPGS/[[mapping-reconstruction/OG-Mapping]] | voxel/octree anchor | LOD/anchor structure |
| GS-SDF/[[mapping-reconstruction/GPS-SLAM]] | geometry-first | teacher/residual design |
