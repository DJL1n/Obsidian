...
### Concepts
- [[Primitive-Level-Reliability]] — 每个 anchor/Gaussian 应有 uncertainty state
- [[Appearance-vs-Geometry-Uncertainty]] — 两层 uncertainty 分开建模
...
### Project
- [[10_Projects/SkelGS-SLAM/decision-log|SkelGS-SLAM: VarSplat 分析]]
